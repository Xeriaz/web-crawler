 ...
 */
final class Version20200827194029 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__base_routes AS SELECT id, base_route FROM base_routes');
        ...
        $this->addSql('INSERT INTO base_routes (id, base_route) SELECT id, base_route FROM __temp__base_routes');
        $this->addSql('DROP TABLE __temp__base_routes');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_5AB55ADABFEFB1AB');
        $this->addSql('CREATE TEMPORARY TABLE __temp__base_routes AS SELECT id, base_route FROM base_routes');
        $this->addSql('DROP TABLE base_routes');
